...
metadata {
    definition(name:DRIVER_NAME, namespace:"dandanache", author:"Dan Danache", importUrl:"https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/E1810.groovy") {
        ...
        // For firmware: 24.4.5 (117C-11C1-24040005)
...
def configure(auto = false) {
    ...
    // Configure IKEA Tradfri Remote Control (E1810) specific Zigbee reporting
    // -- No reporting needed

    // Add IKEA Tradfri Remote Control (E1810) specific Zigbee binds
...
def parse(String description) {
    ...
    switch (msg) {
        ...
        // ---------------------------------------------------------------------------------------------------------------
        // Handle IKEA Tradfri Remote Control (E1810) specific Zigbee messages
        // ---------------------------------------------------------------------------------------------------------------
