...
def configure(auto = false) {
    ...
    // Configure IKEA Symfonisk Sound Remote Gen2 (E2123) specific Zigbee reporting
    // -- No reporting needed

    // Add IKEA Symfonisk Sound Remote Gen2 (E2123) specific Zigbee binds
...
def parse(String description) {
    ...
    switch (msg) {
        ...
        // ---------------------------------------------------------------------------------------------------------------
        // Handle IKEA Symfonisk Sound Remote Gen2 (E2123) specific Zigbee messages
        // ---------------------------------------------------------------------------------------------------------------
