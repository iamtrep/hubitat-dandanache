...
metadata {
    definition(name:DRIVER_NAME, namespace:'dandanache', author:'Dan Danache', importUrl:'https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/Ikea_E1743.groovy') {
        ...
        fingerprint profileId:'0104', endpointId:'01', inClusters:'0000,0001,0003,0009,0020,1000,FC7C', outClusters:'0003,0004,0006,0008,0019,0102,1000', model:'TRADFRI on/off switch', manufacturer:'IKEA of Sweden'  // For firmware: 2.2.010, 24.4.6 (117C-11C5-24040006)
    ...
    preferences {
        input(
            ...
            title: '''
            <div style="min-height:55px; background:transparent url('https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/img/Ikea_E1743.webp') no-repeat left center;background-size:auto 55px;padding-left:60px">
                IKEA Tradfri On/Off Switch (E1743) <small>v5.0.0</small><br>
                <small><div>
                • <a href="https://dan-danache.github.io/hubitat/ikea-zigbee-drivers/#tradfri-onoff-switch-e1743" target="_blank">device details</a><br>
