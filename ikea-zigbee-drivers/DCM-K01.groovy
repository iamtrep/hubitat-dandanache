...
metadata {
    definition(name:DRIVER_NAME, namespace:"dandanache", author:"Dan Danache", importUrl:"https://raw.githubusercontent.com/dan-danache/hubitat/master/ikea-zigbee-drivers/DCM-K01.groovy") {
        ...
        // Attributes for devices.DCM-K01
...
def updated(auto = false) {
    ...
    // Preferences for devices.DCM-K01
...
def configure(auto = false) {
    ...
    // Configuration for devices.DCM-K01
...
def parse(String description) {
    ...
    switch (msg) {
        ...
        // Other events that we expect but are not usefull for devices.DCM-K01 behavior
