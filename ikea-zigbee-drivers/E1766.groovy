...
def configure(auto = false) {
    ...
    // Configure IKEA Tradfri Open/Close Remote (E1766) specific Zigbee reporting
    // -- No reporting needed

    // Add IKEA Tradfri Open/Close Remote (E1766) specific Zigbee binds
    cmds += "zdo bind 0x${device.deviceNetworkId} 0x01 0x01 0x0102 {${device.zigbeeId}} {}" // Window Covering cluster
...
def parse(String description) {
    ...
    switch (msg) {
        ...
        // ---------------------------------------------------------------------------------------------------------------
        // Handle IKEA Tradfri Open/Close Remote (E1766) specific Zigbee messages
        // ---------------------------------------------------------------------------------------------------------------
